...
func detectNetworkElastic(p packet.Packet) {
	...
	for _, line := range lines {
		...
		err = rabbitmq.ToRabbitMQ_Details(config.Viper.GetString("ELASTIC_PREFIX")+"_memory", &Collect_MemoryNetwork{}, &MemoryNetwork{}, values, uuid, p.GetRkey(), ip, name, "0", "0", "0", "0", "ed_mid", "nil", "nil", "memory_network")
		if err != nil {
