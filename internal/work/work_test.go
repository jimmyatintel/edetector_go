...
func TestParseNetowrk(t *testing.T) {
	...
	test := []struct {
	...
	}{
		{
			...
			ip: ip,
			want: []string{"3648", "1700057349", "1701872474", "20.90.153.243", "443", "0.0.0.0", "53751", "unknown", "in", "detect", "53751", "-", "0", "0", "20.90.153.243", "443", "GB", "0", "51"},
		},
	}
	for _, tt := range test {
...
func TestGetriskscore(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotLevel, gotScore, _ := Getriskscore(*tt.memory)
