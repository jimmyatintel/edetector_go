...
func init() {
	dbMap = map[string]func(agent string, line string, values []string) error {
		...
		// "ChromeKeywordSearch": ChromeKeywordSearchTable,
		// "ChromeLogin": ChromeLoginTable,
		// "DNSInfo": DNSInfoTable,
		// "EdgeBookmarks": EdgeBookmarksTable,
		// "EdgeCache": EdgeCacheTable,
		// "EdgeCookies": EdgeCookiesTable,
		// "EdgeHistory": EdgeHistoryTable,
		// "EdgeLogin": EdgeLoginTable,
		// "EventApplication": EventApplicationTable,
